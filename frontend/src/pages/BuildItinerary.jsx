  ...
  return (
    <main className="min-h-screen bg-[#f5f3ed] text-[#1b2821]">
      ...
      <div className="mx-auto max-w-4xl px-5 py-8 sm:px-8 sm:py-11">
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="mb-5 flex items-center justify-between gap-3">
                ...
                {sections.length > 1 && (
                  <button
                    className="grid h-8 w-8 place-items-center rounded-md text-[#9b655a] transition hover:bg-[#f4e8e4]"
                    type="button"
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                ...
                />
                <span className="self-center text-xs text-[#87928a]">to</span>
                <input
                  className="min-h-8 w-24 rounded-full border border-[#d8ddd6] bg-white px-3 text-xs outline-none"
                  placeholder="End"
                  value={section.end}
                ...
                />
                <span className="inline-flex items-center gap-1.5 rounded-full bg-[#f5eadb] px-3 py-1.5 text-[11px] font-bold text-[#93633c]">
                  Budget
                </span>
                <input
        ...
        <button
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-md border border-dashed border-[#aebbb1] py-3 text-xs font-bold text-[#1f5b45] transition hover:border-[#1f5b45] hover:bg-[#edf3ed]"
          type="button"
          onClick={addSection}
        >
