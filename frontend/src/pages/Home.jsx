      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:flex lg:items-center lg:gap-12">
        <div className="lg:w-1/2">
          ...
          <p className="mt-4 text-lg text-[#41524a]">
            Create beautiful trip plans, invite friends, and capture memories
            along the way.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            {!isSignedIn ? (
              <Link
                to="/clerk/sign-in"
                className="inline-block rounded-md bg-purple-600 px-5 py-3 text-sm font-semibold text-white shadow-sm"
              >
                Get started
              </Link>
            ) : null}
            <Link
              to="/trips"
              className="inline-block rounded-md border border-gray-200 px-5 py-3 text-sm font-medium text-[#405047]"
            >
              Explore trips
            </Link>
          </div>
          <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3">
            <div className="rounded-lg bg-white/60 p-3 text-xs font-semibold text-[#405047]">
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-3">
          <div className="rounded-lg border border-[#e6eee6] bg-white p-5">
            ...
            <p className="mt-2 text-sm text-[#5c6a61]">
              Save itineraries and adapt them for future trips.
            </p>
          </div>
          <div className="rounded-lg border border-[#e6eee6] bg-white p-5">
            <h4 className="font-semibold">Invite friends</h4>
            <p className="mt-2 text-sm text-[#5c6a61]">
              Co-edit plans and coordinate logistics together.
            </p>
          </div>
          <div className="rounded-lg border border-[#e6eee6] bg-white p-5">
            <h4 className="font-semibold">Keep records</h4>
            <p className="mt-2 text-sm text-[#5c6a61]">
              Track expenses, notes and memories in one place.
            </p>
          </div>
        </div>
      </section>
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-white via-purple-50 to-white">
        ...
        <section className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <p className="mt-4 text-lg text-[#41524a]">
            Discover, plan and share trips with friends.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <Link
              to="/login"
              className="inline-block bg-purple-600 text-white px-6 py-3 rounded-md"
            >
              Log in
            </Link>
            <Link
              to="/register"
              className="inline-block border border-gray-200 px-6 py-3 rounded-md"
            >
              Sign up
            </Link>
          </div>
