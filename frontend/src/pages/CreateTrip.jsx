          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            {suggestions.map((suggestion) => (
              <div className="relative" key={suggestion.id}>
                <article className="overflow-hidden rounded-lg border border-[#d8ddd6] bg-[#fbfaf6]">
                  <div
                    className={`h-28 bg-gradient-to-br ${suggestion.color}`}
                  />
                  <div className="p-4">
                    <h3 className="text-sm font-bold">{suggestion.name}</h3>
